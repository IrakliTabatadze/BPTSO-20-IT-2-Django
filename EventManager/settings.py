...
from django.conf.global_settings import EMAIL_HOST_PASSWORD, LOGIN_REDIRECT_URL
...
SECRET_KEY = 'django-insecure-hq#ph6kk555ywo)td1md9h+#1w4a-xd2(4-#sjy9gu%%mx))%k'
...
EMAIL_HOST_PASSWORD = 'zoteajiapzqpiami'
